...
curl -L -o concourse.zip "https://github.com/concourse/concourse/releases/download/v$CONCOURSE_CLI_RELEASE_VERSION/concourse-CONCOURSE_CLI_RELEASE_VERSION-linux-amd64.tgz" | tar -zx -C /usr/local/bin
