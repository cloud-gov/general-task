...
curl -L -o concourse.zip "https://github.com/concourse/concourse/releases/download/v$CONCOURSE_CLI_RELEASE_VERSION/concourse-CONCOURSE_CLI_RELEASE_VERSION-linux-amd64.tgz"
unzip -d /usr/local/bin concourse.zip
# Commented out pending https://bugs.launchpad.net/ubuntu/+source/ruby2.0/+bug/1777174
